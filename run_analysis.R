...
setwd("/home/sascha/Dokumente/Coursera/Getting and cleaning data/Assignment/UCI HAR Dataset") #set working directory
...
rm(list=c("activity_labels","combinedTable","combinedTable_train","combinedTable_test","features","xlabels"))
